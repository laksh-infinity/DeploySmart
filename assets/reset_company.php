...
$result = file_put_contents($jsonFile, json_encode([], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));

if ($result === false) {
    http_response_code(500);
    echo json_encode(['error' => 'Failed to reset config']);
    exit;
}

echo json_encode(['status' => 'reset', 'directoryId' => $target_directory_id]);