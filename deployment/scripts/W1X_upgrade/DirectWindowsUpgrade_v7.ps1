...
# In order to upgrade Windows 11 PC Helath Check needs to be installed.
# Created by Mattias Magnusson 2025-08-12
...
# 3. Run this script with administrative privileges
...
$WIN11_ISO_SOURCE = "https://mmk-dns1.mmk.ki.se/autounattended/scripts/W1X_upgrade/K1000X-W11-X64-EDU-EN-V2.iso"

# WORKING DIRECTORIES - you can modify these if needed
$WORKING_DIR = "C:\TempPath\Win11Upgrade"                 # Main working directory
$TEMP_DIR = "C:\TempPath\W1X" # Temporary directory 
$LOG_DIR = "C:\TempPath\logs" #Log directory
$LOG_FILE = "C:\TempPath\logs\Win11_Upgrade_Progress.log"      # Main log file
$MONITOR_LOG = "C:\TempPath\logs\Win11_Monitor.log"            # Process monitor log file
...
"@
    ...
    $arguments = @(
        ...
        "/pkey", "YW6QK-CVNVD-M4RF9-9QBBB-BBHY3"  # KI VL Windows 11 Education key
    )
